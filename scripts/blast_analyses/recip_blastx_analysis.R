...
tx_lengths <- fread("output/trinity_abundance/RSEM.isoforms.results")
...
##annotated for plot
viral_hits_plot <- fread("output/recip_blast/viral_nr_blastx/viral_annots_plot.csv")
viral_hits_plot <- merge(viral_hits_plot, tx_lengths, by="transcript_id")
...
family_genome_type <- distinct(viral_hits_plot[,c(15,16,17)])
...
plot_data$family <- factor(plot_data$family, levels=c("Marseilleviridae", "Ascoviridae", "Podoviridae", "Siphoviridae", "Adintoviridae", "Nudiviridae", "Baculoviridae",
                                                      "Unclassified DNA virus", "Polydnaviridae", "Phenuiviridae", "Rhabdoviridae",
                                                      "Luteoviridae", "Narnaviridae", "Nodaviridae", "Solemoviridae", "Iflaviridae","Reoviridae", "Totiviridae", "Unclassified RNA virus",
                                                      "Unclassified virus"))
...
##PID above 90
pid90 <- subset(viral_hits_plot, viral_hits_plot$`%_identical_matches`>90)
